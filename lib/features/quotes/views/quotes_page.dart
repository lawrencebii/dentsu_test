...
import 'package:prime_template/features/quotes/componets/quote_tile.dart';
            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  if (provider.quotes != null || provider.quotes != [])
                    ...List.generate(
                        ...
                        (index) => GestureDetector(
                              onTap: () {
                                ...
                                context
                                    .read<QuoteProvider>()
                                    .prefillControllers(provider.quotes[index]);
                                goToRTL(context, QuoteDetails());
